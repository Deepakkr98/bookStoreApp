...
const Navbar = () => {
  // here the code for dark and light button
  ...
  // here the code for stick the navbar
    ...
    >
      <div className="navbar dark:bg-slate-900 dark:text-white">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div>
            <a
              className="bg-black text-white px-3 py-2 p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
